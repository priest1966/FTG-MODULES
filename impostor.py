...
class ImpMod(loader.Module):
    ...
    async def procces_img(self, message, way):
        ...
        if way == "en":
            ...
            imps = ['Was not a traitor', 'turned out to be one of the traitors']
            text2 = f"\n{remain} traitor{'i' if remain == 2 else 'ь'} remained.."
        ...
        await message.edit("Wait a minute...")
