    ...
    async def hidecmd(self, message):
        ...
        if args or reply:
            if reply:
                ...
                else: return await message.edit("This is not a media." )
            else:
        ...
        else: return await message.edit("No arguments or replay on media.")