# -*- coding: utf-8 -*-
 ...
 awaitutils.answer(message, t_check)
 check = post('http://gg.gg/check',
 data={'custom_path': None, 'use_norefs': '0',
 'long_url': long_url, 'app': 'site',
 'version': '0.1'}).text
 if check != "ok":
 awaitutils.answer(message, check)
 return
 awaitutils.answer(message, "Create...")
 short = post('http://gg.gg/create',
 data={'custom_path': None, 'use_norefs': '0',
 'long_url': long_url, 'app': 'site',
 'version': '0.1'}).text
 awaitutils.answer(message, short)
 ...
 long_url = m_text
 awaitutils.answer(message, "Creating...")
 fetcher = post(
 'https://clck.ru/--?url=' +
 long_url).text
 awaitutils.answer(message, fetcher)
